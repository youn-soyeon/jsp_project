...
public class MemberDAO {
	...
	public int isMember(MemberBean member) {
		String sql = "SELECT MEMBER_PW FROM MEMBERLIST WHERE MEMBER_ID=?";
		int result = -1;
	...
	public MemberBean getDetailMember(String id) {
		String sql = "SELECT * FORM MEMBERLIST WHERE MEBMER_ID=?";
	...
	// String sql = "DELETE FROM MEMBERLIST WHERE MEMBER_ID=?";
	// int result = 0;
	// try {
	// con = ds.getConnection();
	// pstmt = con.prepareStatement(sql);
	...
	public boolean deleteMember(String id) {
		...
		String sql2 = "DELETE FROM MEMBERLIST WHERE MEMBER_ID=?";
